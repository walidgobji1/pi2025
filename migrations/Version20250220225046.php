 ...
 */
final class Version20250220225046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_de_naissance DATE DEFAULT NULL, user_type VARCHAR(255) NOT NULL, cv VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, niveau VARCHAR(255) DEFAULT NULL, score_evaluation DOUBLE PRECISION DEFAULT NULL, score_avis DOUBLE PRECISION DEFAULT NULL, status TINYINT(1) DEFAULT NULL, niveau_etude INT DEFAULT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
