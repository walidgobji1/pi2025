 ...
 */
final class Version20250210224839 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis ADD formation_id INT DEFAULT NULL, ADD formation_score_id INT DEFAULT NULL, ADD instructeur_id INT DEFAULT NULL, ADD apprenant_id INT DEFAULT NULL, ADD note DOUBLE PRECISION NOT NULL, ADD commentaire LONGTEXT DEFAULT NULL, ADD date_creation DATETIME NOT NULL, ADD update_date DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis DROP formation_id, DROP formation_score_id, DROP instructeur_id, DROP apprenant_id, DROP note, DROP commentaire, DROP date_creation, DROP update_date');
