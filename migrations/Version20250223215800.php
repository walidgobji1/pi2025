 ...
 */
final class Version20250223215800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD titre VARCHAR(255) NOT NULL, ADD date DATE NOT NULL, ADD description VARCHAR(255) NOT NULL, ADD photo VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE promotion ADD apprenant_id INT DEFAULT NULL, ADD inscription_cours_id INT DEFAULT NULL, ADD code_promo VARCHAR(255) NOT NULL, ADD description VARCHAR(255) NOT NULL, ADD remise DOUBLE PRECISION NOT NULL, ADD date_expiration DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP titre, DROP date, DROP description, DROP photo');
