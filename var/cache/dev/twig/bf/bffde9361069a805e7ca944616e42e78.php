...
class __TwigTemplate_8203c0aa2afdf8a48ba1024826aa7353 extends Template
{
...
\t\t\t<a href=\"";
        // line 112
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_inscription_cours_edit", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["inscription_cour"]) || array_key_exists("inscription_cour", $context) ? $context["inscription_cour"] : (function () { throw new RuntimeError('Variable "inscription_cour" does not exist.', 112, $this->source); })()), "id", [], "any", false, false, false, 112)]), "html", null, true);
...
";
    ...
    {
        return array (  254 => 112,  250 => 111,  241 => 105,  234 => 101,  227 => 97,  220 => 93,  213 => 89,  206 => 85,  199 => 81,  190 => 74,  177 => 73,  102 => 7,  89 => 6,  65 => 3,  42 => 1,);
    }
...
\t\t\t<a href=\"{{ path('app_inscription_cours_edit', {'id': inscription_cour.id}) }}\" class=\"btn btn-warning\">Modifier</a>
\t\t</div>

\t</div>
{% endblock %}
", "inscription_cours/show.html.twig", "C:\\Users\\walid\\Desktop\\Nouveau dossier\\pi2025\\templates\\inscription_cours\\show.html.twig");
    }
}
