...
class __TwigTemplate_7e8424062d703aa1c33602d13c269671 extends Template
{
    ...
    <div class=\"form-card\">
        ...
        <div class=\"form-group\">
            ";
        // line 48
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 48, $this->source); })()), "pdfFile", [], "any", false, false, false, 48), 'label', ["label_attr" => ["class" => "form-label"]]);
        yield "
            ";
        // line 49
        yield $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 49, $this->source); })()), "pdfFile", [], "any", false, false, false, 49), 'widget', ["attr" => ["class" => "form-control"]]);
        yield "
            ";
        // line 50
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 50, $this->source); })()), "pdfFile", [], "any", false, false, false, 50), "vars", [], "any", false, false, false, 50), "errors", [], "any", false, false, false, 50));
        foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
            // line 51
            yield "                <div class=\"error-message\">❌ ";
...
";
    ...
    {
        return array (  228 => 58,  223 => 56,  218 => 53,  209 => 51,  205 => 50,  201 => 49,  197 => 48,  191 => 44,  182 => 42,  178 => 41,  174 => 40,  170 => 39,  164 => 35,  155 => 33,  151 => 32,  147 => 31,  143 => 30,  137 => 26,  128 => 24,  124 => 23,  120 => 22,  116 => 21,  111 => 18,  106 => 15,  97 => 13,  93 => 12,  89 => 10,  87 => 9,  81 => 6,  75 => 3,  72 => 2,  49 => 1,);
    }
...
<div class=\"form-container\">
    ...
    <div class=\"form-card\">
        ...
        <div class=\"form-group\">
            ...
            {% for error in form.pdfFile.vars.errors %}
                <div class=\"error-message\">❌ {{ error.message }}</div>
            {% endfor %}
        </div>
...
{% endblock %}
", "lecon/_form.html.twig", "C:\\Users\\walid\\Desktop\\Nouveau dossier\\pi2025\\templates\\lecon\\_form.html.twig");
    }
}
