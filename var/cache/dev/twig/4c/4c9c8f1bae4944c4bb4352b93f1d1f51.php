...
class __TwigTemplate_97bc5ea63fd292239869c094e427635a extends Template
{
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["lecon"]) {
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, $context["lecon"], "pdfFileName", [], "any", false, false, false, 31)) {
                    // line 32
                    yield "                                    <a href=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_lecon_download_pdf", ["id" => CoreExtension::getAttribute($this->env, $this->source, $context["lecon"], "id", [], "any", false, false, false, 32)]), "html", null, true);
                    yield "\" class=\"btn btn-primary\">Télécharger le cours</a>
                                ";
                } else {
                    // line 34
                    yield "                                    <button class=\"btn btn-secondary\" disabled>Aucun PDF disponible</button>
                                ";
                }
                // line 36
                yield "
...
";
    ...
    {
        return array (  261 => 48,  255 => 44,  252 => 43,  248 => 41,  230 => 36,  226 => 34,  220 => 32,  218 => 31,  213 => 29,  209 => 28,  205 => 27,  192 => 24,  175 => 23,  170 => 20,  152 => 16,  138 => 15,  135 => 14,  118 => 13,  115 => 12,  111 => 10,  109 => 9,  104 => 7,  101 => 6,  88 => 5,  64 => 3,  41 => 1,);
    }
                        ...
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                {% if lecon.pdfFileName %}
                                    <a href=\"{{ path('app_lecon_download_pdf', {'id': lecon.id}) }}\" class=\"btn btn-primary\">Télécharger le cours</a>
                                {% else %}
...
{% endblock %}
", "lecon/showClient.html.twig", "C:\\Users\\Yassm\\Desktop\\newpi\\pi2025\\templates\\lecon\\showClient.html.twig");
    }
}
