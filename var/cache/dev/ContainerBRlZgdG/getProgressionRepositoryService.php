 ...
 */
class getProgressionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProgressionRepository' shared autowired service.
     *
     * @return \App\Repository\ProgressionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProgressionRepository.php';

        return $container->privates['App\\Repository\\ProgressionRepository'] = new \App\Repository\ProgressionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
