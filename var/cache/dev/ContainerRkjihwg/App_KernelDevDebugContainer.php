...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.message_image' => 'getSmartUniqueNamer_MessageImageService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('VL8ammbuzT', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6jJMAKI2Pg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1dK4im44bB', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('afMADBGikz', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pa8H8y98p6', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('PJkMskt6We', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('9Ut-L7lj-f', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('kvykGAtriK', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vLdkqO8ezY', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('nOZYXFti5q', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LFWujWbD65', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'vich_uploader.listener.clean.message_image' => ['privates', 'vich_uploader.listener.clean.message_image', 'getVichUploader_Listener_Clean_MessageImageService', true],
            ...
            'vich_uploader.listener.remove.message_image' => ['privates', 'vich_uploader.listener.remove.message_image', 'getVichUploader_Listener_Remove_MessageImageService', true],
            ...
            'vich_uploader.listener.upload.message_image' => ['privates', 'vich_uploader.listener.upload.message_image', 'getVichUploader_Listener_Upload_MessageImageService', true],
        ], [
            ...
            'vich_uploader.listener.clean.message_image' => '?',
            'vich_uploader.listener.remove.evenement_images' => '?',
            'vich_uploader.listener.remove.formations_images' => '?',
            'vich_uploader.listener.remove.message_image' => '?',
            'vich_uploader.listener.upload.evenement_images' => '?',
            'vich_uploader.listener.upload.formations_images' => '?',
            'vich_uploader.listener.upload.message_image' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.evenement_images'], [['preUpdate'], 'vich_uploader.listener.clean.message_image'], [['preUpdate'], 'vich_uploader.listener.clean.formations_images'], [['postGenerateSchema'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['onSchemaCreateTable'], 'doctrine.orm.messenger.doctrine_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['onFlush'], 'turbo.doctrine.event_listener'], [['postFlush'], 'turbo.doctrine.event_listener'], [['preRemove'], 'vich_uploader.listener.remove.evenement_images'], [['postFlush'], 'vich_uploader.listener.remove.evenement_images'], [['prePersist'], 'vich_uploader.listener.upload.evenement_images'], [['preUpdate'], 'vich_uploader.listener.upload.evenement_images'], [['preRemove'], 'vich_uploader.listener.remove.message_image'], [['postFlush'], 'vich_uploader.listener.remove.message_image'], [['prePersist'], 'vich_uploader.listener.upload.message_image'], [['preUpdate'], 'vich_uploader.listener.upload.message_image'], [['preRemove'], 'vich_uploader.listener.remove.formations_images'], [['postFlush'], 'vich_uploader.listener.remove.formations_images'], [['prePersist'], 'vich_uploader.listener.upload.formations_images'], [['preUpdate'], 'vich_uploader.listener.upload.formations_images']]);
    }
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                ...
                'message_image' => [
                    ...
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/images'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.message_image',
                        'options' => [
