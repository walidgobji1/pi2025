...
<<<<<<<< HEAD:var/cache/dev/ContainerZQ3X81X/getFormationScoreRepositoryService.php
namespace ContainerZQ3X81X;
========
namespace ContainerVvLLc6c;
>>>>>>>> 8611b6e672bfc92a3280990b1971f5e769fb70aa:var/cache/dev/ContainerVvLLc6c/getFormationScoreRepositoryService.php
 ...
 */
class getFormationScoreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FormationScoreRepository' shared autowired service.
     *
     * @return \App\Repository\FormationScoreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FormationScoreRepository.php';

        return $container->privates['App\\Repository\\FormationScoreRepository'] = new \App\Repository\FormationScoreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
