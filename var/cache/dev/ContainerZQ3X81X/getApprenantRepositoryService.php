...
<<<<<<<< HEAD:var/cache/dev/ContainerZQ3X81X/getApprenantRepositoryService.php
namespace ContainerZQ3X81X;
========
namespace ContainerVvLLc6c;
>>>>>>>> 8611b6e672bfc92a3280990b1971f5e769fb70aa:var/cache/dev/ContainerVvLLc6c/getApprenantRepositoryService.php
...
class getApprenantRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ApprenantRepository.php';

        return $container->privates['App\\Repository\\ApprenantRepository'] = new \App\Repository\ApprenantRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
