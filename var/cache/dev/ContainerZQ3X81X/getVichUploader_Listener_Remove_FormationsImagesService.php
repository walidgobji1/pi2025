...
<<<<<<<< HEAD:var/cache/dev/ContainerZQ3X81X/getVichUploader_Listener_Remove_FormationsImagesService.php
namespace ContainerZQ3X81X;
========
namespace ContainerVvLLc6c;
>>>>>>>> 8611b6e672bfc92a3280990b1971f5e769fb70aa:var/cache/dev/ContainerVvLLc6c/getVichUploader_Listener_Remove_FormationsImagesService.php
 ...
 */
class getVichUploader_Listener_Remove_FormationsImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.formations_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['vich_uploader.listener.remove.formations_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('formations_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? self::getVichUploader_MetadataReaderService($container)), ($container->services['vich_uploader.upload_handler'] ?? $container->load('getVichUploader_UploadHandlerService')));
    }
}
